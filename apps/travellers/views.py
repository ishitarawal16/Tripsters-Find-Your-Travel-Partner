...
def index(request):
    return render(request, 'travellers/index.html')
...
def travel(request):
    ...
    return render(request, 'travellers/travelplan.html', context)
...
def addplan(request):
    if 'id' not in request.session:
        ...
        return render(request, 'travellers/addplan.html', context)
...
def show(request, travel_id):
    ...
    return render(request, 'travellers/showdetail.html', context)
